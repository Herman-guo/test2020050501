...
public class CategoryDaoImple implements CategoryDao {
	...
	public List<Category> findAll() {
		...
		try {
			return runner.query("select * from t_category_estore", new BeanListHandler<Category>(Category.class));
	...
	public void save(Category c) {
		QueryRunner runner = new QueryRunner(MyJdbcUtil.getDataSource());
		String sql = "insert into t_category_estore values (?,?)";
		try {
	...
	public Category findByCid(String cid) {
		QueryRunner runner = new QueryRunner(MyJdbcUtil.getDataSource());
		String sql = "select * from t_category_estore where cid = ?";
		try {
	...
	public void update(Category c) {
		QueryRunner runner = new QueryRunner(MyJdbcUtil.getDataSource());
		String sql = "update t_category_estore set cname = ? where cid = ?";
		try {
	...
	public void delete(String cid) {
		QueryRunner runner = new QueryRunner(MyJdbcUtil.getDataSource());
		String sql = "delete from t_category_estore where cid = ?";
		try {
