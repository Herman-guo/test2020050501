...
public class UserDaoImple implements UserDao {
	...
	public boolean saveUser(User user) {
		...
		String sql = "insert into t_user_estore values (?,?,?,?,?,?)";
	...
	public User findUserByCode(String code) {
		QueryRunner runner = new QueryRunner(MyJdbcUtil.getDataSource());
		String sql = "select * from t_user_estore where code = ?";
		try {
	...
	public void updateUser(User user) {
		QueryRunner runner = new QueryRunner(MyJdbcUtil.getDataSource());
		String sql = "update t_user_estore set username = ? , password = ?,email = ?,state = ?,code = ? where uid = ?";
	...
	public User login(User user) {
		QueryRunner runner = new QueryRunner(MyJdbcUtil.getDataSource());
		String sql = "select * from t_user_estore where username = ? and password = ? and state = ?";
		try {
